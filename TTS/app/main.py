...
async def synthesize_speech(request: dict):
    ...
    try:
        ...
        logger.info("tts_request_received", extra={
        ...
        # Generate audio
        logger.info(f"[TTS-SERVICE] Generating audio for correlation_id={correlation_id}")
        ...
        logger.info("tts_audio_generated", extra={
            "correlation_id": correlation_id,
